  ...
  for(int itemsAdded = 0; selection < 18; selection++){
    ...
    if(neededData(selection)){
      switch(itemsAdded){
        case 0:
          start_endTime = value;
        //  cout << "start_endTime = " << start_endTime << endl;
          break;
        case 1:
          studentCount += atoi(value.c_str());
        //  cout << "studentCount1 = " << studentCount << endl;
          break;
        case 2:
          studentCount += atoi(value.c_str());
        //  cout << "studentCount2 = " << studentCount << endl;
          break;
        case 3:
          instructor = value;
